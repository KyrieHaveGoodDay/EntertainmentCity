...
!(function (t, e) {
  ...
  function Aa(t, e) {
    var r;
    if (
      ((e._time || (e._initted && !e._dur)) && ((r = xa(t.rawTime(), e)), (!e._dur || Tt(0, e.totalDuration(), r) - e._tTime > U) && e.render(r, !0)),
  ...
  function Gb(t, e) {
    for (var r, i = t._first; i; )
      i instanceof qt
        ? Gb(i, e)
        : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === e || (i.timeline ? Gb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
        (i = i._next);
  }
  function Ib(t, e, r, i) {
    void 0 === r &&
  ...
  function Kk(t) {
    var e,
      ...
      s = !0 === t;
    if (
      (k < a && (C += a - A), (0 < (e = (i = (S += a) - C) - z) || s) && ((n = ++b.frame), (T = i - 1e3 * b.time), (b.time = i /= 1e3), (z += e + (D <= e ? 4 : D - e)), (r = 1)), s || (m = g(Kk)), r)
    )
  ...
  var Rt,
    ...
    Nt =
      ...
      (Rt.totalTime = function totalTime(t, e) {
        ...
        return (
          (this._tTime !== t || (!this._dur && !e) || (this._initted && Math.abs(this._zTime) === U) || (!t && !this._initted && (this.add || this._ptLookup))) &&
    ...
    return (
      ...
      (e.getTweensOf = function getTweensOf(t, e) {
        for (var r, i = [], n = xt(t), a = this._first, s = q(e); a; )
          a instanceof Qt
            ? da(a._targets, n) && (s ? (!Yt || (a._initted && a._ts)) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) && i.push(a)
  ...
  var Yt,
    Xt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
      ...
      if (
        (o(i) &&
          (~i.indexOf('random(') && (i = fb(i)), '=' === i.charAt(1) && ((!(l = parseFloat(d) + parseFloat(i.substr(2)) * ('-' === i.charAt(0) ? -1 : 1) + (Pa(d) || 0)) && 0 !== l) || (i = l))),
        d !== i)
      )
        return isNaN(d * i) || '' === i
          ? (f || e in t || N(e, i),
    ...
    Qt = (function (C) {
      ...
      return (
          ...
          if (p) {
            ...
            !(function _renderZeroDurationTween(t, e, r, i) {
              ...
              if (
                (h &&
                  t._repeat &&
                  ((l = Tt(0, t._tDur, e)), (a = gt(l, h)), (s = gt(t._tTime, h)), t._yoyo && 1 & a && (u = 1 - u), a !== s && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
        ...
        (e.invalidate = function invalidate() {
          return (
            (this._pt = this._op = this._startAt = this._onUpdate = this._lazy = this.ratio = 0), (this._ptLookup = []), this.timeline && this.timeline.invalidate(), C.prototype.invalidate.call(this)
          );
        }),
  ...
  function Xd(t, e, r) {
    var i,
      ...
      f = r.style;
    for (n in (l.svg
      ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[Ye] = e), (i = $e(r, 1)), wd(r, Ye), r.setAttribute('transform', a))
        ...
        for (f in (fe || rd(), e))
          if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Sb(f, e, r, i, t, n)))
            if (((h = typeof s), (l = Qe[f]), 'function' === h && (h = typeof (s = s.call(r, i, t, n))), 'string' === h && ~s.indexOf('random(') && (s = fb(s)), l)) l(this, t, f, s, r) && (y = 1);
              ...
              if (
                (w && f in w
                  ? ((a = 'function' == typeof w[f] ? w[f].call(r, i, t, n) : w[f]), f in Y.units && !Pa(a) && (a += Y.units[f]), '=' === (a + '').charAt(1) && (a = Ad(t, f)))
                  : (a = Ad(t, f)),
                (u = parseFloat(a)),
